...
// @dart=2.9
class quiz_chapter2G extends StatefulWidget {
  static const String screenRoute = 'quiz_chapter2G_screen';

  @override
  _quiz_chapter2GState createState() => _quiz_chapter2GState();
}

class _quiz_chapter2GState extends State<quiz_chapter2G> {
  ...
  var que = [
    questions(
        'السؤال 1 : ',
        ["test_girl/images-test/GlovGT.gif", "test_girl/images-test/GlovGF.gif"],
        0,
        "test_boy/audio-test/glovgirl.mp3"),
    questions(
        'السؤال 2 : ',
        ["test_girl/images-test/maskGF.gif", "test_girl/images-test/maskGT.gif"],
        1,
        'test_boy/audio-test/maskgirl.mp3'),
    questions(
        'السؤال 3 : ',
        [
          "test_girl/images-test/useSoapGT.gif",
          "test_girl/images-test/useSoapGF.gif"
        ],
        0,
        'test_boy/audio-test/soapgirl.mp3'),
    questions(
        'السؤال 4 : ',
        ["test_girl/images-test/SterGT.gif", "test_boy/images-test/sterFG.gif"],
        0,
        'test_boy/audio-test/stergirl.mp3'),
  ];
