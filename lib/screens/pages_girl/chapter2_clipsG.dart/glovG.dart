...
class glovG extends StatefulWidget {
  static const String screenRoute = 'glovG_screen';

  const glovG({Key? key}) : super(key: key);

  @override
  _glovGState createState() => _glovGState();
}

class _glovGState extends State<glovG> {
  late VideoPlayerController _videoPlayerController;
  @override
  void initState() {
    super.initState();
    _videoPlayerController = VideoPlayerController.asset('videos/glovG.mp4')
      ..initialize().then((_) {
        setState(() {});
