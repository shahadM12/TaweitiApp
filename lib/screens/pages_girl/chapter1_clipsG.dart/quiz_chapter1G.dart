...
// @dart=2.9
class quiz_chapter1G extends StatefulWidget {
  static const String screenRoute = 'quiz_chapter1G_screen';

  @override
  _quiz_chapter1GState createState() => _quiz_chapter1GState();
}

class _quiz_chapter1GState extends State<quiz_chapter1G> {
  ...
  var que = [
    questions(
        ...
        0,
        "test_boy/audio-test/washgirl.mp3"),
    questions(
        'السؤال 2 : ',
        ["test_boy/images-test/bathF.gif", "test_boy/images-test/bathT.gif"],
        1,
        'test_boy/audio-test/bathgirl.mp3'),
    questions(
        'السؤال 3 : ',
        [
          "test_boy/images-test/teethFG.gif",
          "test_boy/images-test/teethTG.gif"
        ],
        1,
        'test_boy/audio-test/teethgirl.mp3'),
  ];
