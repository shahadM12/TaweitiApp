...
// @dart=2.9
class quiz_chapter2 extends StatefulWidget {
  static const String screenRoute = 'quiz_chapter2_screen';

  @override
  _quiz_chapter2State createState() => _quiz_chapter2State();
}

// test_boy/images-test/useGlovT.gif
//  - test_boy/images-test/useMaskT.gif
//  - test_boy/images-test/useSoapF.gif
//  - test_boy/images-test/useSterT.gif//
class _quiz_chapter2State extends State<quiz_chapter2> {
  ...
  var que = [
    questions(
        ...
        [
          "test_boy/images-test/useGlovT.gif",
          "test_boy/images-test/useGlovF.gif"
        ],
        0,
        "test_boy/audio-test/glovboy.mp3"),
    questions(
        'السؤال 2 : ',
        [
          "test_boy/images-test/useMaskF.gif",
          "test_boy/images-test/useMaskT.gif"
        ],
        1,
        'test_boy/audio-test/maskboy.mp3'),
    questions(
        'السؤال 3 : ',
        [
          "test_boy/images-test/useSoapT.gif",
          "test_boy/images-test/useSoapF.gif"
        ],
        0,
        'test_boy/audio-test/soapboy.mp3'),
    questions(
        'السؤال 4 : ',
        [
          "test_boy/images-test/useSterT.gif",
          "test_boy/images-test/useSterF.gif"
        ],
        0,
        'test_boy/audio-test/sterboy.mp3'),
  ];
