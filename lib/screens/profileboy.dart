...
class profileboy extends StatefulWidget {
  static const String screenRoute = 'profile_boy_screen';

  const profileboy({Key? key}) : super(key: key);

  @override
  State<profileboy> createState() => _profileboyState();
}

class _profileboyState extends State<profileboy> {
