...
// @dart=2.9
class quiz_chapter3 extends StatefulWidget {
  static const String screenRoute = 'quiz_chapter3_screen';

  @override
  _quiz_chapter3State createState() => _quiz_chapter3State();
}

//  - test_boy/images-test/spaceF.gif
//- test_boy/images-test/touchF.gif
// - test_boy/images-test/thingsT.gif
class _quiz_chapter3State extends State<quiz_chapter3> {
  ...
  var que = [
    questions(
        ...
        0,
        "test_boy/audio-test/spaceboy.mp3"),
    questions(
        'السؤال 2 : ',
        ["test_boy/images-test/touchF.gif", "test_boy/images-test/touchTG.gif"],
        1,
        'test_boy/audio-test/touchboy.mp3'),
    questions(
        'السؤال 3 : ',
        [
          "test_boy/images-test/thingsT.gif","test_boy/images-test/thingsFG.gif"
        ],
        0,
        'test_boy/audio-test/thingsboy.mp3'),
  ];
