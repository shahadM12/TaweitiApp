...
class Chapter2G extends StatefulWidget {
  static const String screenRoute = 'chapter2G_screen';

  @override
  _Chapter2GState createState() => _Chapter2GState();
}

class _Chapter2GState extends State<Chapter2G> {
              ...
              children: <Widget>[
                Container(
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      Navigator.pushNamed(context, glovG.screenRoute);
                    },
                    title: Text(
                      'إرتداء القفازات',
                      style: TextStyle(
                ...
                Container(
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      Navigator.pushNamed(context,maskG.screenRoute);
                    },
                    title: Text(
                      'إرتداء الكمامة',
                      style: TextStyle(
                ...
                Container(
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      Navigator.pushNamed(context, soapG.screenRoute);
                    },
                    title: Text(
                      'إستخدام الصابون',
                      style: TextStyle(
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      Navigator.pushNamed(context, sterilizerG.screenRoute);
                    },
                    title: Text(
                      'إستخدام المعقم',
                      style: TextStyle(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        SizedBox(height: 30),
                        MyButton(
                          enable: videosInSeasons[1][3],
                          color: Color.fromARGB(255, 47, 145, 162),
                          title: 'إختبار قصير',
                          onPressed: () {
                            Navigator.pushNamed(
                            context,quiz_chapter2G.screenRoute);
                          },
                        ),
                      ],
                    ),
